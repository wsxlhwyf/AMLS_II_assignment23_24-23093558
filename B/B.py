...
model_path = 'model_Kuzushiji_B.pt'
...
plt.axis('off')
#plt.show()
plt.savefig("visualize_one_image_B.png", bbox_inches='tight', dpi=300)
...
plt.savefig("kuzushiji_detection_recognition_B.png", bbox_inches='tight', dpi=300)
